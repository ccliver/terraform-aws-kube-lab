...
| <a name="input_max_node_instances"></a> [max\_node\_instances](#input\_max\_node\_instances) | The maximum number of nodes to launch | `number` | n/a | yes |
| <a name="input_min_node_instances"></a> [min\_node\_instances](#input\_min\_node\_instances) | The minimum number of nodes to launch | `number` | n/a | yes |
